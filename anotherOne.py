...
IMG_SIZE = 224 
class_names = ['Battery', 'Keyboard', 'Microwave', 'Mobile', 'Mouse', 'Printer', 'Television', 'Washing Machine'] 
...
st.set_page_config(page_title="E-Trash Classifier", layout="centered")
st.title("🗑️ E-Trash Classifier")
st.write("Upload an image or use your webcam to classify E-trash .")
